...
@section('content')
        ...
        <div class="container-xl px-4">
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">Today is {{ date('j F Y') }}</div>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container-xl px-4 mt-n10">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-8 col-xxl-12">
                                <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                    <h1 class="text-primary">Selamat datang di aplikasi SKPI!!</h1>
                                    <p class="text-gray-700 mb-0">Aplikasi untuk memberikan apresiasi kegiatan yang dilakukan oleh siswa
                                    </p>
                                </div>
                            </div>
        ...
        <div class="card mb-4">
            <div class="card-header">Kegiatan Siswa</div>
            <div class="card-body">
